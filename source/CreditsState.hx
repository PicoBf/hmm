...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
		        ...
		        [''],
			['The Qi san ban mod help me people'],
			['ZhuiMingShiLiu','liu','My fr help me','https://b23.tv/8qdF4dv',	'444444'],
			['QianNingDaDie','qian','He helps me too','https://b23.tv/CNyd2oo','C30085'],
			['TianLongVXZ','Dragon','Tell me how to make week json','https://b23.tv/CwEoq9J','279ADC'],
			[''],
