		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					...
					#else
					createCoolText(['ninjamuffin99', 'Source Code Author', 'kawaisprite', 'fuck him!lol']);
					#end
				// credTextShit.visible = true;
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('Gan Hongbang Change it', 15);
				...
				// credTextShit.text += '\nNi';
				case 15:
					addMoreText('MA!!!'); // credTextShit.text += '\nMA!!!';
